    ...
    a.extend(a.mobile.datebox.prototype.options, {
        ...
        calbox: function () {
            ...
            for (z = {
                ...
                t: I,
                p: H
            }, e = t._cal_gen(C, P, O, !u.calOnlyMonth, x.get(1)), !a.isFunction(u.calFormatter) && u.calFormatter !== !1 && a.isFunction(window[u.calFormatter]) && (u.calFormatter = window[u.calFormatter]), !a.isFunction(u.calBeforeAppendFunc) && u.calBeforeAppendFunc !== !1 && a.isFunction(window[u.calBeforeAppendFunc]) && (u.calBeforeAppendFunc = window[u.calBeforeAppendFunc]), r = new Date(t.theDate.get(0), e[0][0][1], e[0][0][0], 0, 0, 0, 0), s = new Date(t.theDate.get(0), e[e.length - 1][6][1], e[e.length - 1][6][0], 0, 0, 0, 0), t.calDateVisible = t.calBackDate === !1 ? !0 : u.calOnlyMonth ? !1 : t.calBackDate.comp() < r.comp() || t.calBackDate.comp() > s.comp() ? !1 : !0, h = 0, j = e.length; j > h; h++) {
                for (l = a("<div>", {
                    "class": w + "gridrow"
                    ...
                    text: e[h][i][0],
                    "class": ""
                }, u.calBeforeAppendFunc(a("<div>").html(p.text).addClass(w + "griddate ui-corner-all ui-btn").addClass(D === e[h][i][1] || y.force ? "ui-btn-" + y.theme + (y.ok ? "" : " ui-state-disabled") : w + "griddate-empty").addClass(p["class"]).css(D === e[h][i][1] || u.calOnlyMonth ? {} : {
                    cursor: "pointer"

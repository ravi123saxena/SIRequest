/*! jQuery-Mobile-DateBox  |2015-08-13T19:10:45Z | (c) 2010,  2015 JTSage | https://github.com/jtsage/jquery-mobile-datebox/blob/master/LICENSE.txt */!function (a) {
    a.widget("mobile.datebox", {
        ...
        __: function (a) {
            ...
            return "undefined" != typeof b[e] ? b[e] : "undefined" != typeof c && "undefined" != typeof c[a] ? c[a] : "undefined" != typeof d && "undefined" != typeof d[a] ? d[a] : b.lang["default"][a]
        },
        __fmt: function () {
            var a = this,
                b = this.options;
        ...
        _destroy: function () {
            ...
            b.d.wrap.removeClass("ui-input-has-clear"), d.remove(), c.lockInput && b.d.input.removeAttr("readonly"), b.d.input.off("datebox").off("focus.datebox").off("blur.datebox").off("change.datebox"), b.d.mainWrap.popup("destroy"), a(document).off(b.drag.eMove).off(b.drag.eEnd).off(b.drag.eEndA)
        },
        _create: function () {
        ...
        _stdBtn: {
            cancel: function () {
                var b = this,
                    c = this.options;
                return a("<a href='#' role='button'>" + b.__("cancelButton") + "</a>").addClass("ui-btn ui-btn-" + c.themeClearButton + " ui-icon-delete ui-btn-icon-left ui-shadow ui-corner-all").on(c.clickEventAlt, function (a) {
                    a.preventDefault(), b._t({
                        method: "close",
                        closeCancel: !0
                    })
